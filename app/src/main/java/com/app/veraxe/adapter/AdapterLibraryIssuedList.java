 ...
 */
public class AdapterLibraryIssuedList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterLibraryIssuedList(Context context, OnCustomItemClicListener lis, ArrayList<ModelStudent> list) {
