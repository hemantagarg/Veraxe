 ...
 */
public class AdapterMonthlyPlanner extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterMonthlyPlanner(Context context, OnCustomItemClicListener lis, ArrayList<ModelStudent> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_monthlyplanner, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof CustomViewHolder) {
            ...
            ((CustomViewHolder) holder).rl_download.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView text_name, text_date, text_name_title;
