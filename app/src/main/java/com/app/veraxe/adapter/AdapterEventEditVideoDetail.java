 ...
 */
public class AdapterEventEditVideoDetail extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterEventEditVideoDetail(Context context, OnCustomItemClicListener lis, ArrayList<ModelStudent> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(
                    R.layout.row_event_edit_video, parent, false);
